  ...
  return (
    <div className="min-h-screen flex w-full bg-slate-50" dir="rtl">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="bg-white/80 backdrop-blur-sm border-b border-slate-200 px-3 sm:px-4 py-2.5 sm:py-3 shadow-sm sticky top-0 z-30">
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              className="p-1.5 sm:p-2 rounded-lg hover:bg-slate-100 transition-colors md:hidden"
              onClick={() => setSidebarOpen(true)}
            >
              <Menu className="w-5 h-5 text-slate-600" />
            </button>
            <h1 className="text-base sm:text-lg font-bold text-slate-800">פלוגה ב'</h1>
          </div>
        </header>
